...
public final class Paillier {
	...
	private void KeyGeneration(int bitLengthVal, int certainty) {
		...
		if (g.modPow(lambda, nsquare).subtract(BigInteger.ONE).divide(n).gcd(n).intValue() != 1) {
			PrinterTools.errorsLog("g is not good. Choose g again.");
			System.exit(1);
		}
	}
	...
	/**
	 * sums parameters when they are encrypted
	 * 
	 * @param em
	 *            indeterminate numbe of bigintegers
	 * @return BigInteger
	 */
	 ...
	 * 
	 * @param em
	 *            Encryted multiplication
	 * @return plaintext as a BigInteger
	 */
	public String ProviderFunction(BigInteger em) {
		return Decryption(em).toString();
	}
}