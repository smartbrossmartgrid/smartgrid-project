...
public class Zona {
	...
	private int numero_viviendas; // numero de contadores
	private int gasto_energetico; // gasto total actual
	private float porcentaje_gasto; // porcentaje de gasto con respecto al total

	//tecnicos, ocupados y disponibles

	private int tecnicos_disp = 25;
